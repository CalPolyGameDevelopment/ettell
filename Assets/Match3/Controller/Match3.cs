...
public class Match3 : MonoBehaviour, MiniGameAPI.IMiniGame {
	...
	private void genBoard() {
		...
		int width = int.Parse(XmlUtilities.getDatumFromNode<string>(data, XmlUtilities.WIDTH, XmlUtilities.getData<string>));
		int height = int.Parse(XmlUtilities.getDatumFromNode<string>(data, XmlUtilities.HEIGHT, XmlUtilities.getData<string>));
